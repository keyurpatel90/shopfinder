...
class Edit extends \Keyurpatel90\Shopfinder\Controller\Adminhtml\Shopfinder
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('keyurpatel90_shopfinder_shopfinder', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Shopfinder'));
        return $resultPage;
    }
}
