...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'keyurpatel90_shopfinder/tmp/shopfinder/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'keyurpatel90_shopfinder/shopfinder/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'keyurpatel90_shopfinder/tmp/shopfinder/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'keyurpatel90_shopfinder/shopfinder/file';
    ...
    public function __construct(
        ...
        File $file,
        $baseTmpPath = 'keyurpatel90_shopfinder/tmp/shopfinder/image',
        $basePath = 'keyurpatel90_shopfinder/shopfinder/image'
    ...
    public function removeFile($imageName){
        ...
        $mediaRootDir = $this->getBaseUrl().'/'.$this->getBasePath().'/';
        
        if ($this->file->isExists($mediaRootDir.$imageName))  {

            $this->file->deleteFile($mediaRootDir. $imageName);
        }
    }
